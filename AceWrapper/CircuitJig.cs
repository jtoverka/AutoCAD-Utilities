...
namespace AceWrapper
{
	...
	public class CircuitJig : EntityJig
	{
		...
		/// <summary>
		/// Gets or Sets the distance tolerance to update the circuit.
		/// </summary>
		/// <remarks>Default value is <see cref="Tolerance.Global"/></remarks>
		...
		protected override SamplerStatus Sampler(JigPrompts prompts)
		{
			...
			if (result.Value.IsEqualTo(dragPoint, Tolerance))
