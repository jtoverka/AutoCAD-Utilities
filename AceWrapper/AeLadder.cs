...
namespace AceWrapper
{
	...
	public class AeLadder
	{
		...
		public void Refresh()
		{
			...
			Attributes wdm_Attributes = AeXData.Default();
            wdm_Attributes.GetAttributes(wdmIdField);

			Attributes wdmlr_Attributes = AeXData.Default();
            wdmlr_Attributes.GetAttributes(wdmlrIdField);
